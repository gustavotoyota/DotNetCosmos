...
namespace EntityFramework.Models
{
    ...
    public class SchemaAnnotations
    {
        ...
        [Column(name: "Name")] // Allows granular control over the database column
        ...
        [MaxLength(200)] // Specifies the maximum length of the string in the database
        public required string Description { get; set; }

        [ForeignKey("Foreign")] // Used to configure a foreign key in the relationship between two entities
        ...
        [DatabaseGenerated(DatabaseGeneratedOption.Computed)] // Specifies how the database generates values for a property
